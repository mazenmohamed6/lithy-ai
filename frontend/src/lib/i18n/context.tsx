...
const en = {
  ...
  atsScanner: {
    ...
    subtitle: "Optimize your resume to pass Applicant Tracking Systems and land more interviews.",
    resumeAndJob: "Resume & Job Description",
    resumeAndJobDesc: "Paste your resume content and the target job description",
    resumeContent: "Resume Content",
    industry: "Industry",
    jobDesc: "Job Description",
    analyze: "Analyze ATS Score",
    analyzing: "Analyzing...",
    result: "ATS Compatibility Score",
    noResult: "Your results will appear here",
    noResultDesc: "Paste your resume and job description above, then click Analyze to see how well your resume matches.",
    loadingResult: "Analyzing your resume against the job description...",
    reset: "Analyze Another Resume",
    breakdown: "Score Breakdown",
    matchedKeywords: "Matched Keywords",
    missingKeywords: "Missing Keywords",
    keywordMatch: "Keyword Match Rate",
    formatParsing: "Format & Parsing",
    recommendations: "Recommendations",
  },
};
...
const ar: typeof en = {
  ...
  atsScanner: {
    title: "محلل درجة ATS",
    subtitle: "حسّن سيرتك الذاتية لاجتياز أنظمة تتبع المتقدمين واحصل على مقابلات أكثر.",
    resumeAndJob: "السيرة الذاتية والوصف الوظيفي",
    resumeAndJobDesc: "الصق محتوى سيرتك الذاتية والوصف الوظيفي المستهدف",
    resumeContent: "محتوى السيرة الذاتية",
    industry: "المجال",
    jobDesc: "الوصف الوظيفي",
    analyze: "تحليل درجة ATS",
    analyzing: "جاري التحليل...",
    result: "درجة توافق ATS",
    noResult: "ستظهر نتائجك هنا",
    noResultDesc: "الصق سيرتك الذاتية والوصف الوظيفي أعلاه، ثم انقر تحليل لرؤية مدى توافق سيرتك.",
    loadingResult: "جاري تحليل سيرتك الذاتية مقابل الوصف الوظيفي...",
    reset: "تحليل سيرة ذاتية أخرى",
    breakdown: "توزيع الدرجات",
    matchedKeywords: "الكلمات المفتاحية المتطابقة",
    missingKeywords: "الكلمات المفتاحية المفقودة",
    keywordMatch: "نسبة تطابق الكلمات المفتاحية",
    formatParsing: "التنسيق والتحليل",
    recommendations: "التوصيات",
  },
};
